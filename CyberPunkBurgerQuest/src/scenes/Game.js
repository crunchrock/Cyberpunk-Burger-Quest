...
export default class Game extends Phaser.Scene
{
	...
	create()
	{	
		const bgMusic1 = this.sound.add('cityrunnerII')
		bgMusic1.play();
		...
		//badguy physics! to kill player if touched by badguy
	...
	{   
		...
		//ADDING my own cheeseburger level up target at 10 & 20 burgers
	
		if (this.burgersCollected >= 10) {
			this.game.sound.stopAll()
